...
namespace EFFramework.Editor
{
    ...
    public static class ReleaseTools
    {
        ...
        [MenuItem("EFFramework/Quick Build/一键打包AssetBundle")]
        ...
        [MenuItem("EFFramework/Quick Build/一键打包MacOS", false, 90)]
        public static void AutomationBuildMacOS()
        {
            BuildTarget target = EditorUserBuildSettings.activeBuildTarget;
            BuildDLLCommand.BuildAndCopyDlls(target);
            AssetDatabase.Refresh();
            BuildInternal(target, Application.dataPath + "/../Builds/OSX", packageVersion: GetBuildPackageVersion());
            AssetDatabase.Refresh();
            BuildImp(BuildTargetGroup.Standalone, BuildTarget.StandaloneOSX, $"{Application.dataPath}/../Builds/OSX/Release_OSX");
        }

        [MenuItem("EFFramework/Quick Build/一键打包Window", false, 90)]
        ...
        [MenuItem("EFFramework/Quick Build/一键打包Android", false, 90)]
        public static void AutomationBuildAndroid()
        {
            ...
            BuildImp(BuildTargetGroup.Android, BuildTarget.Android, $"{Application.dataPath}/../Builds/Android/Android.apk");
        }

        [MenuItem("EFFramework/Quick Build/一键打包IOS", false, 90)]
        ...
        {
            EditorUserBuildSettings.SwitchActiveBuildTarget(buildTargetGroup, buildTarget);//BuildTarget.StandaloneWindows64);
            AssetDatabase.Refresh();
            ...
            {
                EditorUtility.OpenFolderPanel("a", locationPathName, "b");
