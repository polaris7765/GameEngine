...
namespace EFFramework.Editor
{
    public static class LubanTools
    {
        ...
        {
            Application.OpenURL(Application.dataPath + @"/../../Configs/AppConfig/gen_code_bin_to_project_lazyload.bat");
        }
        
        [MenuItem("EFFramework/Tools/打开表格目录")]
        public static void OpenConfigFolder()
        {
            OpenFolderHelper.Execute(Application.dataPath + @"/../../Configs/AppConfig");
        }
    }
}