...
namespace EFFramework.Editor
{
    ...
    public static class OpenFolderHelper
    {
        ...
        /// 打开 Data Path 文件夹。
        /// </summary>
        [MenuItem("EFFramework/Open Folder/Data Path", false, 10)]
        ...
        /// </summary>
        [MenuItem("EFFramework/Open Folder/Persistent Data Path", false, 11)]
        ...
        /// </summary>
        [MenuItem("EFFramework/Open Folder/Streaming Assets Path", false, 12)]
        ...
        /// </summary>
        [MenuItem("EFFramework/Open Folder/Temporary Cache Path", false, 13)]
        ...
        /// </summary>
        [MenuItem("EFFramework/Open Folder/Console Log Path", false, 14)]
