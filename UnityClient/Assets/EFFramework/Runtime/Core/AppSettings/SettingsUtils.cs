...
{
    private static readonly string GlobalSettingsPath = $"EFFrameworkGlobalSettings";
    private static FrameworkSettings _globalSettings;
    ...
    public static FrameworkSettings GlobalSettings
    {
        get
        {
            ...
            {
                _globalSettings = GetSingletonAssetsByResources<FrameworkSettings>(GlobalSettingsPath);
            }
