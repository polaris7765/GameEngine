...
namespace EFFramework
{
    ...
    public readonly struct FrameworkLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(FrameworkLinkedListRange<T> range)
            {
                ...
                m_Current = m_FrameworkLinkedListRange._first;
            ...
            {
                if (m_Current == null || m_Current == m_FrameworkLinkedListRange._terminal)
                {
                    return false;
                }
