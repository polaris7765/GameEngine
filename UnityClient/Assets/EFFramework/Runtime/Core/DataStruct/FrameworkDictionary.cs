...
namespace EFFramework
{
    ...
    public class FrameworkDictionary<TKey, TValue>
    {
        ...
        /// <summary>Removes all keys and values from the <see cref="T:EFFramework.EFFrameworkDictionary`2" />.</summary>
        public void Clear()
        {
            KeyList.Clear();
            Dictionary.Clear();
    ...
    /// <typeparam name="TKey">指定字典Key的元素类型。</typeparam>
    /// <typeparam name="TValue">指定字典Value的元素类型。</typeparam>
    public class FrameworkSortedDictionary<TKey, TValue> : FrameworkDictionary<TKey, TValue>
    {
