...
namespace AppMain
{
    public class TextMode
    {
        ...
        public string Label_Load_FirstUnpack = "首次进入应用，正在初始化应用资源...（此过程不消耗网络流量）";
        ...
        public string Label_Load_Force = "检测到版本更新，取消更新将导致无法进入应用";

        public string Label_Load_Force_WIFI =
            "检测到有新的应用内容需要更新，\n更新包大小<color=#BA3026>{0}</color>, \n取消更新将导致无法进入应用，您当前已为<color=#BA3026>wifi网络</color>，请开始更新";

        public string Label_Load_Force_NO_WIFI =
            "检测到有新的应用内容需要更新，\n更新包大小<color=#BA3026>{0}</color>, \n取消更新将导致无法进入应用，请开始更新";

        public string Label_Load_Error = "更新参数错误{0}，请点击确定重新启动应用";
        public string Label_Load_FirstEntrerGame_Error = "首次进入应用资源异常";
        public string Label_Load_UnpackComplete = "正在加载最新资源文件...（此过程不消耗网络流量）";
        public string Label_Load_UnPackError = "资源解压失败，请点击确定重新启动应用";
        ...
        public string Label_App_id = "APPVer {0}"; //"应用版本号:{0}";
        public string Label_Res_id = "ResVer {0}"; //"资源版本号:{0}";
        public string Label_Clear_Comfirm = "是否清理本地资源?(清理完成后会关闭应用且重新下载最新资源)";
        public string Label_RestartApp = "本次更新需要重启应用，请点击确定重新启动应用";
        ...
        public string Label_PreventionOfAddiction = "著作人权：XX市EFFramework有限公司 软著登记号：2022SR0000000\n抵制不良应用，拒绝盗版应用。注意自我保护，谨防受骗上当。适度应用益脑，" +
                                                    "沉迷应用伤身。合理安排时间，享受健康生活。";
        ...
        public string Label_Dlc_Load_Force_WIFI =
            "检测到有新的应用内容需要更新, 取消更新将导致无法进入应用，您当前已为<color=#BA3026>wifi网络</color>，请开始更新";

        public string Label_Dlc_Load_Force_NO_WIFI =
            "检测到有新的应用内容需要更新, 取消更新将导致无法进入应用，请开始更新";
